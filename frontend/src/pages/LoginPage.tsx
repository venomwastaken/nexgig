...
interface LoginPageProps {
  onSubmit?: (email: string, password: string, keepSignedIn: boolean) => Promise<void> | void;
...
export default function LoginPage({ onSubmit, onNavigateToSignUp }: LoginPageProps) {
  ...
  <span className="text-[#1b976f]">Gig</span>
      ...
      <form onSubmit={handleSubmit} className="mt-8 space-y-6" noValidate>
        ...
        <div className="flex items-center justify-between text-sm">
          ...
          <a href="#" className="text-[#8B8F9B] hover:text-[#1b976f] transition-colors">
            Forgot password?
          </a>
        </div>
